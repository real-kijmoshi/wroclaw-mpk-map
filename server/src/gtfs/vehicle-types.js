...
const readVehicleTypes = (zip) => {
  ...
  for (const raw of parseTable(buffer)) {
    ...
    types.set(id, {
      ...
      lowFloor,
      // Floor height alone does not establish wheelchair space or boarding
      // access. Only an explicit accessibility field may answer this.
      wheelchair: wheelchairColumn,
